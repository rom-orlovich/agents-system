...
export function AnalyticsFeature() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <section className="panel h-[400px]" data-label="COST_TREND_30D">
        <h2 className="text-sm mb-4 font-heading text-gray-400">BURN_RATE_OVER_TIME</h2>
      ...
      <section className="panel h-[400px]" data-label="AGENT_EFFICIENCY">
        <h2 className="text-sm mb-4 font-heading text-gray-400">COMPUTE_DISTRIBUTION_BY_AGENT</h2>
        <ResponsiveContainer width="100%" height="100%">
