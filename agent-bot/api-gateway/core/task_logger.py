...
class TaskLogger:
    ...
    def log_webhook_event(self, stage: str, **data: Any) -> None:
        event = {
    ...
    def log_queue_event(self, stage: str, **data: Any) -> None:
        event = {
            "timestamp": datetime.now(timezone.utc).isoformat(),
            "stage": stage,
            "task_id": self.task_id,
    ...
    def log_agent_output(self, output_type: str, **data: Any) -> None:
        event = {
            "timestamp": datetime.now(timezone.utc).isoformat(),
            "type": output_type,
            "task_id": self.task_id,
    ...
    def log_microservice_call(self, service: str, stage: str, **data: Any) -> None:
        event = {
            "timestamp": datetime.now(timezone.utc).isoformat(),
            "service": service,
            "stage": stage,
