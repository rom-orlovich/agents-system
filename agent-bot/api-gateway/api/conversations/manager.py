...
class ConversationManager:
    ...
    async def get_context(
        ...
        return ConversationContext(
            ...
            first_message_at=count_row["first_at"] if count_row else datetime.now(timezone.utc),
            last_message_at=count_row["last_at"] if count_row else datetime.now(timezone.utc),
        )
