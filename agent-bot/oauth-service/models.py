...
class Installation(Base):
    ...
    status: Mapped[str] = mapped_column(String(50), nullable=False, default=InstallationStatus.ACTIVE.value, index=True)
    
    external_org_id: Mapped[str] = mapped_column(String(255), nullable=False, index=True)
    external_org_name: Mapped[str | None] = mapped_column(String(255), nullable=True)
    external_install_id: Mapped[str | None] = mapped_column(String(255), nullable=True, index=True)
