...
from core.database.repositories import InstallationRepository
from shared import Installation, InstallationCreate, InstallationUpdate
...
class TokenService:
    ...
    async def create_installation(self, data: InstallationCreate) -> Installation:
        logger.info(
